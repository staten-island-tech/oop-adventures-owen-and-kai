                        ...
                        if tutorial_boss_turn == Attack:
                            if tutorial_boss_turn_attack == Jab:
                                if Tutorial_Boss.stamina >= 10:
                                    ...
                                    if tutorial_boss_enemy_spontaneous_strike_chance and player_spontaneous_strike_chance == Hit:
                                        ...
                                        player_health -= Jab.damage and Tutorial_Boss.health -= Jab.damage
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina}) 
                                        continue
                                    ...
                                    if tutorial_boss_enemy_spontaneous_strike_chance == Hit and player_spontaneous_strike_chance == Miss:
                                        ...
                                        player_health -= Jab.damage and Tutorial_Boss.health = Tutorial_Boss
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina}) 
                                        continue
                                    ...
                                    if tutorial_boss_enemy_spontaneous_strike_chance == Miss and player_spontaneous_strike_chance == Hit:
                                        ...
                                        player_health = player_health and Tutorial_Boss.health -= Jab.damage
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina})     
                                        continue
                                    ...
                                    if tutorial_boss_enemy_spontaneous_strike_chance and player_spontaneous_strike_chance == Miss:
                                        ...
                                        player_health = player_health and Tutorial_Boss.health = Tutorial_Boss.health
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina})     
                                        continue
                            ...
                            if tutorial_boss_turn_attack == Straight:
                                if Tutorial_Boss.stamina >= 30:
                                    ...
                                    if tutorial_boss_enemy_spontaneous_strike_chance and player_spontaneous_strike_chance == Hit:
                                        print(f"And we have a amazing spectalce! Both {player_story_name} and {Tutorial_Boss.name} hit each other at the same time! ")
                                        player_health -= Straight.damage and Tutorial_Boss.health -= Straight.damage
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina}) 
                                        continue

                                    if tutorial_boss_enemy_spontaneous_strike_chance == Hit and player_spontaneous_strike_chance == Miss:
                                        print(f"Oh! What a spectacle! Both competitiors crash into each other but {Tutorial_Boss.name}'s punch collides and {player_story_name}'s only misses by a large margain!")
                                        player_health -= Straight.damage and Tutorial_Boss.health = Tutorial_Boss
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina}) 
                                        continue

                                    if tutorial_boss_enemy_spontaneous_strike_chance == Miss and player_spontaneous_strike_chance == Hit:
                                        print(f"Oh! What do we have here?! {player_story_name} and {Tutorial_Boss.name} have swung at each other at the same time! However, {player_story_name}'s punch collides hard with {Tutorial_Boss.name}'s face and {Tutorial_Boss.name} only misses his face by a few inches! ")  
                                        player_health = player_health and Tutorial_Boss.health -= Straight.damage
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina})     
                                        continue
                            ...
                            if tutorial_boss_turn_attack == Left_Hook:
                                if Tutorial_Boss.stamina >= 15:
                                    ...
                                    if tutorial_boss_enemy_spontaneous_strike_chance and player_spontaneous_strike_chance == Hit:
                                        print(f"And we have a amazing spectalce! Both {player_story_name} and {Tutorial_Boss.name} hit each other at the same time! ")
                                        player_health -= Left_Hook.damage and Tutorial_Boss.health -= Left_Hook.damage
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina}) 
                                        continue

                                    if tutorial_boss_enemy_spontaneous_strike_chance == Hit and player_spontaneous_strike_chance == Miss:
                                        print(f"Oh! What a spectacle! Both competitiors crash into each other but {Tutorial_Boss.name}'s punch collides and {player_story_name}'s only misses by a large margain!")
                                        player_health -= Left_Hook.damage and Tutorial_Boss.health = Tutorial_Boss
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina}) 
                                        continue

                                    if tutorial_boss_enemy_spontaneous_strike_chance == Miss and player_spontaneous_strike_chance == Hit:
                                        print(f"Oh! What do we have here?! {player_story_name} and {Tutorial_Boss.name} have swung at each other at the same time! However, {player_story_name}'s punch collides hard with {Tutorial_Boss.name}'s face and {Tutorial_Boss.name} only misses his face by a few inches! ")   
                                        player_health = player_health and Tutorial_Boss.health -= Left_Hook.damage
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina})     
                                        continue
                            ...
                            if tutorial_boss_turn_attack == Right_Hook:
                                if Tutorial_Boss.stamina >= 45:
                                    ...
                                    if tutorial_boss_enemy_spontaneous_strike_chance and player_spontaneous_strike_chance == Hit:
                                        print(f"And we have a amazing spectalce! Both {player_story_name} and {Tutorial_Boss.name} hit each other at the same time! ")
                                        player_health -= Right_Hook.damage and Tutorial_Boss.health -= Right_Hook.damage
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina}) 
                                        continue

                                    if tutorial_boss_enemy_spontaneous_strike_chance == Hit and player_spontaneous_strike_chance == Miss:
                                        print(f"Oh! What a spectacle! Both competitiors crash into each other but {Tutorial_Boss.name}'s punch collides and {player_story_name}'s only misses by a large margain!")
                                        player_health -= Right_Hook.damage and Tutorial_Boss.health = Tutorial_Boss
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina}) 
                                        continue

                                    if tutorial_boss_enemy_spontaneous_strike_chance == Miss and player_spontaneous_strike_chance == Hit:
                                        print(f"Oh! What do we have here?! {player_story_name} and {Tutorial_Boss.name} have swung at each other at the same time! However, {player_story_name}'s punch collides hard with {Tutorial_Boss.name}'s face and {Tutorial_Boss.name} only misses his face by a few inches! ") 
                                        player_health = player_health and Tutorial_Boss.health -= Right_Hook.damage
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina})         
                                        continue
                            ...
                            if tutorial_boss_turn_attack == Right_Uppercut:
                                if Tutorial_Boss.stamina >= 60:
                                    ...
                                    if tutorial_boss_enemy_spontaneous_strike_chance and player_spontaneous_strike_chance == Hit:
                                        print(f"And we have a amazing spectalce! Both {player_story_name} and {Tutorial_Boss.name} hit each other at the same time! ")
                                        player_health -= Right_Uppercut.damage and Tutorial_Boss.health -= Right_Uppercut.damage
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina}) 
                                        continue

                                    if tutorial_boss_enemy_spontaneous_strike_chance == Hit and player_spontaneous_strike_chance == Miss:
                                        print(f"Oh! What a spectacle! Both competitiors crash into each other but {Tutorial_Boss.name}'s punch collides and {player_story_name}'s only misses by a large margain!")
                                        player_health -= Right_Uppercut.damage and Tutorial_Boss.health = Tutorial_Boss
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina}) 
                                        continue

                                    if tutorial_boss_enemy_spontaneous_strike_chance == Miss and player_spontaneous_strike_chance == Hit:
                                        print(f"Oh! What do we have here?! {player_story_name} and {Tutorial_Boss.name} have swung at each other at the same time! However, {player_story_name}'s punch collides hard with {Tutorial_Boss.name}'s face and {Tutorial_Boss.name} only misses his face by a few inches! ")
                                        player_health = player_health and Tutorial_Boss.health -= Right_Uppercut.damage
                                        print(f"Health:"{player_health} "Stamina:"{player_stamina})          
                                        continue
