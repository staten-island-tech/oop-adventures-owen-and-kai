...
while True:
    if filler == "Continue":
        scene1_pt1 = input("BOOM! BANG! POW! The sounds of fists colliding in the gym is almost like a melody. You're in your own corner, concentrating on your own bag.  Choices: Continue/Skip ")

        if scene1_pt1 == "Continue":
            scene1_pt2 = input("Jab. Straight to the body. Left feint. Left hook to the body followed by another one to the head. Endless amounts of combos are forming in your head, and you continue to beat the bag before you to a pulp.  Choices: Continue/Skip ")
        ...
        if scene1_pt3 == "Continue":
            scene1_pt4 = input("Instead, he diverts his attention to someone else, someone that is nothing more than a pebble in your way to you: John Parksinson, the pride of the Wilson Boxing Gym.  Choices: Continue/Skip ")
...
while True:
    ...
    if scene1_dialogue_choice1 == "1":
        scene1_dialogue1 = input(f"{player_story_name}: I wasn't looking at you.  Choices: Continue/Skip ")

        if scene1_dialogue1 == "Continue":
            scene1_pt7 = input("You don't know why these words left your mouth; only a few seconds ago you were thinking you would be able to beat John easily. However, now that he was in front of you in person, you feel almost like a mere bug in front of the pressure of his presence.  Choices: Continue/Skip ")
        ...
        if scene1_pt7 == "Continue":
            scene1_dialogue2 = input("John: oH YeS yOu WerE. NoW lEt mE BeAt yoU tO A PulP. I diDn'T lIkE yOu tHE DaY I SAw YoU.  Choices: Continue/Skip ")
        ...
        if scene1_dialogue2 == "Continue":
            scene1_pt8 = input("John cranks back his hand and closes it into a fist into what seems to be a hook. It's slow, anyone could easily dodge it. However, somehow you're unable to move; the pressure being emitted from him is too strong.  Choices: Continue/Skip ")
        ...
        if scene1_pt8 == "Continue":
            scene1_pt9 = input("You flinch and you mentally get ready for the pain that is about to come. However, Coach Wilson suddenly appears between the two of you and puts a hand on John's shoulder.  Choices: Continue/Skip ")
        ...
        if scene1_pt9 == "Continue":
            scene1_dialogue3 = input("Coach Wilson: Alright now Johnny, we don't want to waste your punches on some weakling like him.  Choices: Continue/Skip ")
        ...
        if scene1_dialogue3 == "Continue":
            scene1_dialogue4 = input("John: wElL, aT lEAsT leT mE BEat HiM uP iN thE RiNg!  Choices: Continue/Skip ")
        ...
        if scene1_dialogue4 == "Continue":
            scene1_dialogue5 = input("Coach Wilson: Well, if you insist on wrecking this piece of trash in front of everyone, I'll give you what you want.  Choices: Continue/Skip ")
        ...
        if scene1_dialogue5 == "Continue":
            scene1_pt10 = input("Coach Wilson throws a pair of boxing gloves at your face which snaps you back to reality.  Choices: Continue/Skip ")
        ...
        if scene1_pt10 == "Continue":
            scene1_dialogue6 = input(f"{player_story_name}: O-Okay...  Choices: Continue/Skip ")
    ...
    if scene1_dialogue_choice1 == "2":
        scene1_dialogue1 = input(f"{player_story_name}: What am I looking at? Of course it's that blob of a brain that you have! All that muscle's not going to help you in a fight if it belongs to that retard of a brain you have.  Choices: Coninue/Skip ")
        ...
        if scene1_pt7 == "Continue":
            scene1_dialogue2 = input("John: HoW dARe yOU SaY tHaT tO mE!  Choices: Continue/Skip ")
        ...
        if scene1_pt9 == "Continue":
            scene1_dialogue3 = input("Coach Wilson: Woah there, Johnny boy, cooldown, don't let this kid here provoke you. We don't want any trouble.  Choices: Continue/Skip ")
        ...
        if scene1_dialogue3 == "Continue":
            scene1_dialogue4 = input("John: ThEn aT lEAsT lEt Me beAT hIM iN tHe rInG!  Choices: Continue/Skip ")
        ...
        if scene1_dialogue4 == "Continue":
            scene1_dialogue5 = input(f"Coach Wilson: Alright, alright, {player_story_name}, get your gloves on and get in the ring, your fighting.  Choices: Continue/Skip ")
        ...
        if scene1_dialogue5 == "Continue":
            scene1_dialogue6 = input(f"{player_story_name}: Whatever you say coach. I've been waiting for this moment for some time.  Choices: Continue/Skip ")
